...
document.addEventListener('DOMContentLoaded', () => {
  ...
  newGameBtns.forEach(btn => btn.addEventListener('click', () => {
    ...
    allModals.forEach(modal => { modal.className = 'game-modal'; });
    game = new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */](6, playerName, gameOver);
    })
  );
});
...
class Game {
  ...
  makePlayer(isPlayer) {
    ...
    const playerRow = randomNum(6, __WEBPACK_IMPORTED_MODULE_3__global__["a" /* BOARD_SIZE */] - 6);
    const playerCol = randomNum(6, __WEBPACK_IMPORTED_MODULE_3__global__["a" /* BOARD_SIZE */] - 6);
    const options = {
