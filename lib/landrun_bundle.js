...
class Game {
  ...
  drawLoop() {
    ...
    ctx.fillText((this.lagPortion * 100).toFixed(1) + "%", 5+2, __WEBPACK_IMPORTED_MODULE_3__global__["g" /* SQUARE_SIZE */] + 4)

    ctx.fillStyle = "white";
    ctx.font = "14px 'Press Start 2P'";
    ctx.fillText((this.lagPortion * 100).toFixed(1) + "%", 5, __WEBPACK_IMPORTED_MODULE_3__global__["g" /* SQUARE_SIZE */] + 2);
